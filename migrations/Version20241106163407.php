 ...
 */
final class Version20241106163407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tour_package ADD CONSTRAINT FK_9E82E214C7A0C0B4 FOREIGN KEY (tour_categories_id) REFERENCES tour_category (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tour_package ADD CONSTRAINT FK_9E82E2147210CF21 FOREIGN KEY (tour_category_id) REFERENCES tour_category (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
